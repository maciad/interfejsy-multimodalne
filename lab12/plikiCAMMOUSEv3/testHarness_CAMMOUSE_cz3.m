%% Jarzmo testowe - jarzmo testowe - camera mouse, sterowanie względne
% 
% UWAGI:
%
...
% -------------------------------------------------------
% UZUPEŁNIJ_1 - skopiuj parametry akwizycji z "testHarness_CAMMOUSE_cz1.m"
...
parametryAlg.funkcjasterowania = @sterowanie2;      % nazwa funkcji obliczającej sterowanie kursorem
% -------------------------------------------------------
% UZUPEŁNIJ_2 - dobierz parametry algorytmu dla f. sterowanie2.m
parametryAlg.histereza       = 0.05;            % parametr histerezy dla sterowania względnego (zacznij od 0.05)
parametryAlg.gainx           = 1.0;            % parametr wzmocnienia x dla sterowania względnego (zacznij od 1.0)
parametryAlg.gainy           = 1.0;            % parametr wzmocnienia y dla sterowania względnego (zacznij od 1.0)
% -------------------------------------------------------
    
parametryEksportu  = [];                        % struktura parametrów funkcji eksportu danych
parametryEksportu.nazwapliku = [];              % - nazwa pliku wyjściowego txt
...
%-wizualizacja danych
showObj          = myVisualizationCAMMOUSEpong();
